...
export default function Hero() {
  return (
    <section className="relative min-h-screen bg-warm-50 overflow-hidden flex items-center">
      ...
      <p className="absolute top-4 -left-4 select-none pointer-events-none text-[clamp(6rem,15vw,14rem)] font-black leading-none text-warm-200 tracking-tighter whitespace-nowrap" aria-hidden="true">BUILD</p>
      ...
      <div className="container relative pt-32 pb-20">
        <div className="max-w-4xl">
          ...
          <motion.h1 initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.3 }} className="mt-8 text-hero text-ink max-w-4xl">
            We build <span className="relative inline-block">what others<span className="absolute -top-1 -right-2 text-fire text-[clamp(1.5rem,3vw,3rem)]" aria-hidden="true">*</span></span><br />
            <span className="text-fire">can’t.</span>
          </motion.h1>

          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.45 }} className="mt-6 max-w-lg text-lead text-ink-muted">
